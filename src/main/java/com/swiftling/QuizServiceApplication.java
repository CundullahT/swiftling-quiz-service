...
public class QuizServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication app = new SpringApplication(QuizServiceApplication.class);
        ...
        defaultProperties.put("info.application.name", "swiftling-quiz-service");
        defaultProperties.put("info.application.description", "Swiftling App's Quiz Service");
