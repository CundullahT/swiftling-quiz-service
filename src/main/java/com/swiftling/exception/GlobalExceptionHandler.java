...
//    }
    ...
    @ExceptionHandler(PhraseStatusesCouldNotBeUpdatedException.class)
    public ResponseEntity<ExceptionWrapper> handlePhraseStatusesCouldNotBeUpdatedException(Throwable exception) {
        log.error(exception.getMessage());
        exception.printStackTrace();
        ExceptionWrapper exceptionWrapper = ExceptionWrapper.builder()
                .success(false)
